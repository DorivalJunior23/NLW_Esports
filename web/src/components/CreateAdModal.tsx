...
//import * as Select from '@radix-ui/react-select'; //refazer lista com Select //utilizar lib keen slider para add mais games
//tornar responsivo e validação para o back-end lib rect hoock-form
